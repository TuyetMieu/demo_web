...
export default function LessonPythonPage() {
  ...
  return (
    <div className="lesson-page h-screen flex flex-col overflow-hidden">
      <PageStyles hrefs={["/static/css/lesson.css","/static/css/pages/lesson_python.inline.css","/static/css/chatbot.css","/static/css/edu-theme.css","/static/css/edu-lesson.css"]} />
