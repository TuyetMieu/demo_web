/**
 * curricula.js — giáo trình tĩnh của 5 khóa (xuất nguyên văn từ CURRICULA của
 * bản Flask; trước đây là src/lib/curricula.json import vào React).
 * course_detail.page.js đọc window.CURRICULA + window.LESSON_URLS để dựng
 * danh sách module/bài học y hệt vòng lặp Jinja course_detail() cũ.
 */
window.CURRICULA = {
  "python": {
    "requirements": [
    ...
    "modules": [
      {
        "title": "Module 1: Giới thiệu Python",
        "lessons": [
          "Python là gì và tại sao cần học?",
          "Cài đặt Python & VS Code",
          "Chương trình đầu tiên: Hello World",
          "Cách dùng Python REPL",
          "Biến và quy tắc đặt tên",
          "Kiểu dữ liệu: int, float, str, bool",
          "Toán tử số học và so sánh",
          "Hàm print() và input() cơ bản"
        ]
      },
      {
        "title": "Module 2: Cú pháp cơ bản",
        "lessons": [
          "Chuỗi (String) và các thao tác",
          ...
          "None và kiểm tra None"
        ]
      },
      {
        "title": "Module 3: Cấu trúc điều khiển",
        "lessons": [
          ...
          "Dict comprehension",
          "Vòng lặp lồng nhau",
          "Pattern matching với match/case",
          "Bài tập thực hành: FizzBuzz"
        ]
      },
      {
        ...
        "lessons": [
          ...
          "Import module",
          "Tạo module riêng",
          "Thư viện chuẩn: math, random, os",
          "Virtual environment & pip"
        ]
      },
      {
        "title": "Module 5: Kiểu dữ liệu nâng cao",
        "lessons": [
          "List nâng cao: sort, filter, map",
          ...
          "Frozen set và immutable patterns",
          "Bài tập: Xử lý dữ liệu thực tế",
          "Kiểm tra & đánh giá module 5",
          "Dự án nhỏ: Chương trình quản lý danh sách"
        ]
      },
      {
        "title": "Module 6: Lập trình hướng đối tượng",
        "lessons": [
          "OOP là gì? Tại sao cần OOP?",
          "Class và Object",
          ...
          "Dataclass",
          "Dự án: Hệ thống quản lý ngân hàng"
        ]
      },
      {
        "title": "Module 7: Xử lý File & Exception",
        "lessons": [
          ...
          "Bài tập: Parser file log"
        ]
      },
      {
        "title": "Module 8: Thư viện tiêu chuẩn",
        "lessons": [
          "datetime và xử lý thời gian",
      ...
      {
        "title": "Module 9: NumPy & Pandas",
        "lessons": [
          "Cài đặt và giới thiệu NumPy",
          "Array: tạo, indexing, slicing",
          "Phép toán trên array",
          "Broadcasting",
          "Giới thiệu Pandas",
          "DataFrame: tạo và đọc dữ liệu",
      ...
      {
        "title": "Module 10: AI & Machine Learning",
        "lessons": [
          ...
          "Neural Network với Keras",
          "CNN cơ bản với TensorFlow",
          "NLP: Xử lý văn bản",
          "Dự án cuối khóa: Phân tích cảm xúc",
          "Triển khai model với Flask",
          "Thi chứng chỉ Python",
          "Tổng kết & bước tiếp theo",
          "Cộng đồng & tài nguyên nâng cao",
  ...
  "cpp": {
    ...
    "modules": [
      {
        "title": "Module 1: Giới thiệu C/C++",
        "lessons": [
          "Lịch sử và ứng dụng của C/C++",
          "Cài đặt GCC và IDE",
      ...
      {
        "title": "Module 2: Biến, Kiểu dữ liệu & Toán tử",
        "lessons": [
      ...
      },
      {
        ...
        "lessons": [
          ...
          "break, continue, goto",
          "Vòng lặp lồng nhau",
          "Bài tập: các bài toán cổ điển"
        ]
      },
      {
        "title": "Module 4: Hàm & Con trỏ",
        "lessons": [
          "Khai báo và định nghĩa hàm",
          "Truyền tham số (by value vs by ref)",
          "Con trỏ cơ bản",
          "Toán tử & và *",
          "Con trỏ và mảng",
          "Con trỏ đến con trỏ",
      ...
      {
        "title": "Module 5: Mảng & Chuỗi",
        "lessons": [
          "Mảng 1 chiều",
          "Mảng 2 chiều",
          "Chuỗi C-style (char array)",
          "Các hàm xử lý chuỗi",
          "std::string",
          "Mảng động với new/delete",
          "Vector cơ bản",
          "Sắp xếp mảng",
          "Tìm kiếm nhị phân",
          "Bài tập thực hành"
      ...
      {
        "title": "Module 6: Cấu trúc dữ liệu",
        "lessons": [
          "struct trong C",
          "Union",
          "Linked List đơn",
    ...
    "modules": [
      {
        ...
        "lessons": [
          "Java là gì? JVM, JDK, JRE",
          "Cài đặt môi trường Java",
          "Hello World với IntelliJ IDEA",
          "Cấu trúc chương trình Java",
          "Biên dịch và chạy từ terminal",
          "Java Platform: SE, EE, ME",
          "Tổng quan lộ trình học Java",
      ...
      },
      {
        ...
        "lessons": [
          ...
          "Inner class và Anonymous class",
          "Kiểm tra OOP nâng cao"
        ]
      },
      {
        "title": "Module 5: Collections & Generics",
        "lessons": [
      ...
      {
        "title": "Module 7: Java I/O & Files",
        "lessons": [
          "Java I/O streams",
          "BufferedReader/Writer",
          "File và Path",
          "NIO.2: Files & Paths",
          "Đọc/ghi file JSON với Jackson",
          "Serialization",
          "Properties files",
          "Làm việc với CSV",
          "Zip và nén file",
          "Bài tập: File processor"
        ]
      },
      {
        "title": "Module 8: Multithreading",
        "lessons": [
          "Thread và Process",
          "Tạo Thread: extend vs Runnable",
          "Thread lifecycle",
      ...
      {
        "title": "Module 9: Spring Boot cơ bản",
        "lessons": [
          "Spring Framework tổng quan",
          "Spring Boot: khởi tạo project",
          "Dependency Injection & IoC",
          "REST Controller cơ bản",
          "Service và Repository layers",
          "Spring Data JPA",
          "Kết nối PostgreSQL",
          "CRUD API hoàn chỉnh",
          "Request validation",
          ...
          "Bài tập: API quản lý sinh viên",
          "Kiểm tra Spring Boot"
        ]
      },
      {
        "title": "Module 10: Microservices",
        "lessons": [
          "Kiến trúc Microservices là gì?",
          "API Gateway với Spring Cloud",
          "Service Discovery với Eureka",
          "Config Server",
          "Feign Client",
          "Circuit Breaker (Resilience4j)",
          "Message Queue với RabbitMQ",
          "Docker cơ bản cho Java app",
          "Dự án cuối khóa: E-commerce API",
          "Thi chứng chỉ Java"
        ]
      }
    ]
  ...
  "htmlcss": {
    ...
    "modules": [
      {
        "title": "Module 1: HTML cơ bản",
        "lessons": [
          "Web hoạt động như thế nào?",
          "HTML là gì? Cấu trúc tài liệu",
          "Heading, paragraph, span",
          "Liên kết (anchor) và điều hướng",
          "Hình ảnh và media",
          "Danh sách: ol, ul, dl",
          "Bảng (table)",
          "Form và input cơ bản",
          "Semantic HTML5: header, main, footer",
          "article, section, aside, nav",
          "Meta tags và SEO cơ bản",
          "Bài tập: Tạo trang CV cá nhân"
        ]
      },
      {
        "title": "Module 2: HTML nâng cao",
        "lessons": [
          "Form nâng cao: validation HTML5",
          "Input types hiện đại",
          ...
          "ARIA attributes",
          "Iframe và embed",
          "Dự án: Landing page hoàn chỉnh"
        ]
      },
      {
        "title": "Module 3: CSS cơ bản",
        "lessons": [
          "CSS là gì? Cách áp dụng",
          ...
          "Bài tập: Style trang CV"
        ]
      },
      {
        "title": "Module 4: CSS Layout",
        "lessons": [
          "Flexbox cơ bản",
          "Flexbox nâng cao: wrap, align",
          "CSS Grid cơ bản",
          "CSS Grid nâng cao",
          "Grid + Flexbox kết hợp",
          "Float và Clearfix",
          "Multi-column layout",
          "Overflow và Scroll",
          "Centering techniques",
          "Dự án: Dashboard layout"
        ]
      },
      {
        ...
        "lessons": [
          ...
          "Responsive images",
          "Viewport và em/rem units",
          "CSS Container Queries",
          "Bài tập: Website 3 breakpoints"
        ]
      },
      {
        "title": "Module 6: CSS Animations",
        "lessons": [
          "CSS Transitions",
          ...
          "Parallax scrolling cơ bản",
          "Performance: will-change, GPU"
        ]
      },
      {
        "title": "Module 7: Dự án thực tế",
        "lessons": [
          "CSS Variables (Custom Properties)",
          "Dark mode với CSS Variables",
          "CSS Preprocessor: Sass giới thiệu",
          "BEM methodology",
          "Dự án 1: Portfolio website",
          "Dự án 2: E-commerce product page",
          "Dự án 3: Dashboard admin",
          "Dự án 4: Blog layout",
          "Tối ưu hiệu năng CSS",
          "Thi chứng chỉ HTML/CSS"
        ]
      }
    ]
  },
  "db_design": {
    ...
    "modules": [
      {
        "title": "Module 1: ER Model & Mapping",
        "lessons": [
      ...
      {
        "title": "Module 2: Phụ thuộc hàm & Chuẩn hóa (FD & Normal Forms)",
        "lessons": [
      ...
      {
        "title": "Module 3: Application Design",
        "lessons": [
